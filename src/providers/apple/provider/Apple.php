...
namespace verbb\auth\providers\apple\provider;
...
use verbb\auth\providers\apple\provider\exception\AppleAccessDeniedException;
use League\OAuth2\Client\Token\AccessToken;
use League\OAuth2\Client\Token\AccessTokenInterface;
use verbb\auth\providers\apple\token\AppleAccessToken;
