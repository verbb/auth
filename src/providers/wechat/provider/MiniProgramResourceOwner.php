...
namespace verbb\auth\providers\wechat\provider;

use League\OAuth2\Client\Provider\Exception\IdentityProviderException;
use League\OAuth2\Client\Provider\ResourceOwnerInterface;
use verbb\auth\providers\wechat\token\miniprogram\AccessToken;
use verbb\auth\providers\wechat\support\miniprogram\MiniProgramDataCrypt;
