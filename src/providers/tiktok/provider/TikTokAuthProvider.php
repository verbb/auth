...
namespace verbb\auth\providers\tiktok\provider;
...
use verbb\auth\providers\tiktok\grant\TikTokAuthorizationCodeGrant;
use verbb\auth\providers\tiktok\grant\TikTokRefreshTokenGrant;
