<?php
namespace verbb\auth\providers\auth0\provider;

use League\OAuth2\Client\Provider\AbstractProvider;
use League\OAuth2\Client\Token\AccessToken;
use League\OAuth2\Client\Tool\BearerAuthorizationTrait;
use Psr\Http\Message\ResponseInterface;
use verbb\auth\providers\auth0\provider\exception\AccountNotProvidedException;
use verbb\auth\providers\auth0\provider\exception\Auth0IdentityProviderException;
use verbb\auth\providers\auth0\provider\exception\InvalidRegionException;
