<?php
namespace verbb\auth\providers\gotowebinar\resources;

use verbb\auth\providers\gotowebinar\resultset\SimpleResultSet;
use verbb\auth\providers\gotowebinar\resultset\PageResultSet;
use verbb\auth\providers\gotowebinar\helper\DateUtcHelper;
