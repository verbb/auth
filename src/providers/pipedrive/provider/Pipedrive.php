...
namespace verbb\auth\providers\pipedrive\provider;

use verbb\auth\providers\pipedrive\PipedriveResourceOwner;
use verbb\auth\providers\pipedrive\provider\exception\PipedriveIdentityProviderException;
