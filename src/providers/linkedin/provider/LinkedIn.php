...
namespace verbb\auth\providers\linkedin\provider;

use verbb\auth\providers\linkedin\token\LinkedInAccessToken;
use verbb\auth\providers\linkedin\provider\exception\LinkedInAccessDeniedException;
