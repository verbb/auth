...
namespace verbb\auth\providers\mixer\provider;

use verbb\auth\providers\mixer\entity\MixerUser;
use League\OAuth2\Client\Provider\AbstractProvider;
use verbb\auth\providers\mixer\provider\exception\MixerIdentityProviderException;
