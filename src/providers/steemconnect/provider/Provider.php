...
namespace verbb\auth\providers\steemconnect\provider;
...
use verbb\auth\providers\steemconnect\common\http\Request;
use verbb\auth\providers\steemconnect\config\Config;
